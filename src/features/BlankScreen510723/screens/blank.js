...
export class _Blank extends React.Component {
  ...
  state = {
    ...
    Toggle_14: true,
    Input_40: "",
    Datepicker_46: new Date("09/11/2020"),
    Input_43: ""
  }
  ...
  render = () => (
    ...
    >
      ...
      <Input
        ...
        onChangeText={nextValue => this.setState({ Input_40: nextValue })}
      />
      <Datepicker
        style={{
          width: "100%",
        ...
        date={this.state.Datepicker_46}
        onSelect={nextValue => this.setState({ Datepicker_46: nextValue })}
      />
      <Input
        ...
        onChangeText={nextValue => this.setState({ Input_43: nextValue })}
      />
      <Slider
        value={50}
        minimumValue={0}
