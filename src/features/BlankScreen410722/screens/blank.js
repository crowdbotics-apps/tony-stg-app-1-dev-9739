...
export class _Blank extends React.Component {
  ...
  state = {
    ...
    Input_9: "",
    Input_11: "",
    Datepicker_13: new Date("09/11/2020"),
    Input_15: "",
    Toggle_26: true,
    Radio_30: true,
    CheckBox_47: true
  ...
  render = () => (
    ...
    >
      ...
      <Toggle
        ...
        checked={this.state.Toggle_26}
        onChange={nextChecked => this.setState({ Toggle_26: nextChecked })}
      />
      <Radio
        text="Radio button"
        disabled={false}
      ...
      <Image
        ...
        source={{
          uri:
            "https://d3nfddh2sbo9hk.cloudfront.net/media/project_component_resources/Screen_Shot_2020-09-11_at_10.07.16_AM.png"
        }}
        style={{
          width: "100%",
          height: 200,
      ...
      <CheckBox
        ...
        onChange={nextChecked => this.setState({ CheckBox_47: nextChecked })}
      />
    </View>
  )
}
